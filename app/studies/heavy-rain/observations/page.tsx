...
export default function HeavyRainObservationsPage() {
    ...
    <div className="min-h-screen bg-[var(--secondary-light-grey)] py-12">
      <div className="container mx-auto px-4">
        <div className="max-w-6xl mx-auto">
          {/* Header */}
          <div className="mb-8">
            <div className="text-sm text-[var(--secondary-grey)] mb-2">
              <Link href="/studies/heavy-rain" className="text-[var(--link-color)] hover:text-[var(--link-hover)]">
                Heavy Rain Surveys
              </Link>
              {" / Observations"}
            </div>
            <h1 className="text-3xl md:text-4xl font-bold mb-4 text-[var(--primary-navy)]">
              Heavy Rain Survey Observations
            </h1>
              ...
              {filteredObservations.length === 0 ? (
                ...
                filteredObservations.map((obs) => (
                  <div key={obs.id} className="bg-white shadow-lg p-6 hover:shadow-xl transition-shadow">
                    ...
                    <Link
                      href={`/studies/heavy-rain/observations/${obs.id}`}
